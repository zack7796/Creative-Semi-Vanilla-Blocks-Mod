...
public abstract class ClearWater extends FlowableFluid {

    public Fluid getFlowing() {
        return ModFluids.CLEAR_WATER_FLOWING;
    }

    public Fluid getStill() {
        return ModFluids.CLEAR_WATER_STILL;
    }
    ...
    public BlockState toBlockState(FluidState state) {
        return ModBlocks.CLEAR_WATER_BLOCK.getDefaultState().with(FluidBlock.LEVEL, getBlockStateLevel(state));
    }

    public boolean matchesType(Fluid fluid) {
        return fluid == ModFluids.CLEAR_WATER_STILL || fluid == ModFluids.CLEAR_WATER_FLOWING;
    }
    ...
    public static class Flowing extends ClearWater {
    ...
    public static class Still extends ClearWater {
